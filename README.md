### In this video we are going to create a central state using redux store and consume it in our components without passing it as a prop(named Second.js and Third.js)
